...
export class QQClient extends EventEmitter {
  ...
  /** Upload a local file in a private chat (NapCat supports local paths). */
  async uploadPrivateFile(userId, filePath) {
  ...
  /** Upload a local file in a group chat. */
  async uploadGroupFile(groupId, filePath) {
